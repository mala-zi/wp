		...
		$manager->add_section(
			new Fitness_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_text'    => esc_html__( 'GO PRO', 'fitness-elementor' ),
					'pro_url'     => 'https://www.wpelemento.com/elementor/fitness-wordpress-theme/',
					'priority'    => 5,
				)
			)
		);
		$manager->add_section(
			new Fitness_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://www.wpelemento.com/theme-documentation/fitness-elementor/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Fitness_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://www.wpelemento.com/demo/fitness-elementor/',
					'priority'    => 5,
				)
			)
		);
